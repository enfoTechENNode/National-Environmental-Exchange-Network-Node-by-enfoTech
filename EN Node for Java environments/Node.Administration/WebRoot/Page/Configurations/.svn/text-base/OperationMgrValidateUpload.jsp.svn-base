		...
		<title>Exchange Network Node</title>
          ...
          <form action="/Node.Administration/Page/Entry/OperationMgr.do" method="POST" name="form1" enctype="multipart/form-data">
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td class="formTitle" nowrap="nowrap" width="100%" height="20" background="/Node.Administration/eftWC/skin/img/pnl/tskpnl_bar_bg.gif">Upload Validation File</td>
              </tr>
                    <%
