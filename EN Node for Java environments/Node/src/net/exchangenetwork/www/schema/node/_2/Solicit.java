 ...
 */
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
    ...
    public static class Factory{
        ...
        */
        public static Solicit parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Solicit object =
                new Solicit();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Solicit".equals(type)){
                                ...
                                return (Solicit)net.exchangenetwork.www.schema.node._2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list6 = new java.util.ArrayList();
                                    ...
                                    // Process the array and step past its final element's end.
                                    list5.add(net.exchangenetwork.www.schema.node._2.NotificationURIType.Factory.parse(reader));
