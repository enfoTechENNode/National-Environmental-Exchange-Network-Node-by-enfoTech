...
<html>
	<head>
		...
		<title>Exchange Network Node</title>
      	...
      	<body >
          <form action="/Node.Client/Page/WebMethods/Submit.do?version=VER_20" method="POST" name="form1" enctype="multipart/form-data">
                            ...
                            <td>
                              <table width="100%">
                                <tr>
                                  ...
                                  <td>
                                    <select name="nodeAddress3">
                                      <%
                                      	String[] clientURLs = SubmitBean.getClientURLs_V2();
                                      	boolean	isSelected = false;
                                       if (clientURLs != null) {
                                         for (int i = 0; i < clientURLs.length; i++) {
                                           if (clientURLs[i].equals(SubmitBean.getNodeAddress3()))
                                             isSelected = true;
                                         }
                                       }
                                       if (isSelected) {
                                ...
                                <tr>
                                  ...
                                  <td><eftwc:HighlightTextBox id="nodeAddress4" size="80" text="<%=SubmitBean.getNodeAddress4()%>" /></td>
                                </tr>
                              </table>
                            </td>
                          </tr>
                          ...
                          <tr>
                            <td>
                              <table width="100%">
                                      ...
                                      <tr>
                                        <td class="formFldLabel" nowrap="nowrap">Flow Operation:</td>
                                        <td><eftwc:HighlightTextBox id="flowOperation" size="40" text="<%=SubmitBean.getFlowOperation()%>" /></td>
                                      </tr>
                                      <tr>
                                        <td class="formFldLabel" nowrap="nowrap">Recipients:</td>
                                        <td colspan="3"><eftwc:HighlightTextBox id="recipients" size="80" text="<%=SubmitBean.getRecipients()%>" />(Separated by comma)</td>
                                      </tr>
                                      <tr>
                                        <td class="formFldLabel" nowrap="nowrap">NotificationURI:</td>
                                        <td colspan="3"><eftwc:HighlightTextBox id="notificationURI" size="80" text="<%=SubmitBean.getNotificationURI()%>" />(Separated by comma)</td>
                                      </tr>
                                      <tr>
		                                    ...
		                                    <select name="notificationType">
												<%
													...
													for (int i = 0; i < notificationType.length; i++) {
														if (notificationType[i].equals(SubmitBean.getNotificationType())) {
														%>
