...
<html>
	<head>
		...
		<title>Exchange Network Node</title>
      	...
      	<body >
          <form action="/Node.Client/Page/WebMethods/GetStatus.do?version=VER_11" method="POST" name="form1">
                            ...
                            <td>
                              <table width="100%">
                                <tr>
                                  ...
                                  <td>
                                    <select name="nodeAddress1">
                                      <%
                                      	String[] clientURLs = GetStatusBean.getClientURLs();
                                      	boolean	isSelected = false;
                                       if (clientURLs != null) {
                                         for (int i = 0; i < clientURLs.length; i++) {
                                           if (clientURLs[i].equals(GetStatusBean.getNodeAddress1()))
                                             isSelected = true;
                                         }
                                       }
                                       if (isSelected) {
                                ...
                                <tr>
                                  ...
                                  <td><eftwc:HighlightTextBox id="nodeAddress2" size="80" text="<%=GetStatusBean.getNodeAddress2()%>" /></td>
                                </tr>
                              </table>
                            </td>
                          </tr>
