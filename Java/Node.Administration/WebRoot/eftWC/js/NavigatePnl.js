...
function NavigatePnl(instanceName,pnlTitle,pnlWidth)
{
	...
	this.SkinBase = "/Node.Administration/eftWC/skin";
	this.ImgUp = this.SkinBase + "/img/pnl/tskpnl_btn_up.gif";
	this.ImgDown = this.SkinBase + "/img/pnl/tskpnl_btn_down.gif";
	this.ImgPnlTitleLeft = this.SkinBase + "/img/pnl/tskpnl_left.gif";
	this.ImgPnlTitleBG = this.SkinBase + "/img/pnl/tskpnl_title_bg.gif";
...
NavigatePnl.prototype.writeDivHeader = function()
{
	if(this.Style==2)
	{
		this.ImgUp = this.SkinBase + "/img/pnl/tskpnl_btn_up_hl.gif";
		this.ImgDown = this.SkinBase + "/img/pnl/tskpnl_btn_down_hl.gif";
		this.ImgPnlTitleLeft = this.SkinBase + "/img/pnl/tskpnl_left_hl.gif";
		this.ImgPnlTitleBG = this.SkinBase + "/img/pnl/tskpnl_title_bg_hl.gif";
	...
	if(this.DOC_IE || this.DOC_DOM)
	{
		...
		document.write('<table id="TAB_'+this.InstanceName+'" width="'+this.ContainerWidth+'" border="0" cellpadding="0" cellspacing="0" align="'+this.TableAlign+'">');
		...
		document.write('<td nowrap class="'+this.CssTaskPnlTitle+'" id="'+this.InstanceName+'_td">');
		...
		document.write(' style="position:absolute; left:0px; top:0px; display:'+this.initSts+'; visibility:visible; width:'+this.ContentWidth+'px; z-index:999;');
