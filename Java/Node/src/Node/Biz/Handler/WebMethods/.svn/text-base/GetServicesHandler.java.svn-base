...
import Node.Phrase;
/**
 * <p>This class create GetServicesHandler Process.</p>
 * <p>Company: enfoTech & Consulting, Inc.</p>
 * @author enfoTech
 * @version 2.0
 */

public class GetServicesHandler extends Handler {
  ...
  protected Object ExecuteDataflow(String dataflowConfig) throws Exception
  {
      ...
      process.CreateActionParameter(WebServiceParameter.serviceType, this.ServiceType);
  ...
  protected Object Execute () throws RemoteException
  {
    ...
    try {
      if (this.OpID >= 0) {
        ...
        Object[] params = new Object[] { this.Token,this.ServiceType };
