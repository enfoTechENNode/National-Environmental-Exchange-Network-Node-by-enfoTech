                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  net.exchangenetwork.www.schema.node._2.NotificationURIType[] getNotificationURI(){
                               ...
                               */
                              protected void validateNotificationURI(net.exchangenetwork.www.schema.node._2.NotificationURIType[] param){
                             ...
                             /**
                              * Auto generated setter method
                              * @param param NotificationURI
                              */
                              public void setNotificationURI(net.exchangenetwork.www.schema.node._2.NotificationURIType[] param){
                             ...
                             /**
                             * Auto generated add method for the array for convenience
                             * @param param net.exchangenetwork.www.schema.node._2.NotificationURIType
                             */
                             public void addNotificationURI(net.exchangenetwork.www.schema.node._2.NotificationURIType param){
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localNotificationURI);
                               list.add(param);
                               this.localNotificationURI =
                             (net.exchangenetwork.www.schema.node._2.NotificationURIType[])list.toArray(
                            new net.exchangenetwork.www.schema.node._2.NotificationURIType[list.size()]);
                                        ...
                                        xmlWriter.writeStartElement("flowOperation");
                                          ...
                                          if (localFlowOperation==null){
                                              // write the nil attribute
                                                     ...
                                                     throw new org.apache.axis2.databinding.ADBException("flowOperation cannot be null!!");
                                            ...
                                            if (localRecipient[i] != null){
                                                ...
                                                if (!emptyNamespace) {
                                                    if (prefix == null) {
                                                        ...
                                                        xmlWriter.writeStartElement(prefix2,"recipient", namespace);
                                       ...
                                       if (localNotificationURI!=null){
                                            for (int i = 0;i < localNotificationURI.length;i++){
                                                if (localNotificationURI[i] != null){
                                                 localNotificationURI[i].serialize(new javax.xml.namespace.QName("http://www.exchangenetwork.net/schema/node/2","notificationURI"),
                                                           factory,xmlWriter);
                                                } else {
                                               ...
                                               throw new org.apache.axis2.databinding.ADBException("notificationURI cannot be null!!");
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://www.exchangenetwork.net/schema/node/2",
                                        ...
                                        if (localFlowOperation != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localFlowOperation));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("flowOperation cannot be null!!");
                                        }
                                     if (localRecipientTracker){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Submit".equals(type)){
                                ...
                                return (Submit)net.exchangenetwork.www.schema.node._2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list7 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.exchangenetwork.net/schema/node/2","flowOperation").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setFlowOperation(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.exchangenetwork.net/schema/node/2","recipient").equals(reader.getName())){
                                    ...
                                    list5.add(reader.getElementText());
                                            ...
                                            while(!loopDone5){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://www.exchangenetwork.net/schema/node/2","recipient").equals(reader.getName())){
                                                         list5.add(reader.getElementText());
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.exchangenetwork.net/schema/node/2","notificationURI").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list6.add(net.exchangenetwork.www.schema.node._2.NotificationURIType.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone6){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://www.exchangenetwork.net/schema/node/2","notificationURI").equals(reader.getName())){
                                                                    list6.add(net.exchangenetwork.www.schema.node._2.NotificationURIType.Factory.parse(reader));
                                                        ...
                                                        object.setNotificationURI((net.exchangenetwork.www.schema.node._2.NotificationURIType[])
                                    ...
                                    // Process the array and step past its final element's end.
                                    list7.add(net.exchangenetwork.www.schema.node._2.NodeDocumentType.Factory.parse(reader));
