 ...
 */
                        ...
                        */
                           ...
                           */
                           public  net.exchangenetwork.www.schema.node._2.DocumentFormatType getDocumentFormat(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param DocumentFormat
                               */
                               public void setDocumentFormat(net.exchangenetwork.www.schema.node._2.DocumentFormatType param){
                           ...
                           */
                           public  net.exchangenetwork.www.schema.node._2.AttachmentType getDocumentContent(){
                            ...
                            /**
                               ...
                               */
                               public void setDocumentContent(net.exchangenetwork.www.schema.node._2.AttachmentType param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       NodeDocumentType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":NodeDocumentType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "NodeDocumentType",
                           xmlWriter);
                                            ...
                                            if (localDocumentId != null){
                                                ...
                                                writeAttribute("",
                                                         "documentId",
                                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDocumentId), xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                                            ...
                                            if (localDocumentFormat==null){
                                                 throw new org.apache.axis2.databinding.ADBException("documentFormat cannot be null!!");
                                            }
                                           localDocumentFormat.serialize(new javax.xml.namespace.QName("http://www.exchangenetwork.net/schema/node/2","documentFormat"),
                                               factory,xmlWriter);
                                        
                                            if (localDocumentContent==null){
                                                 throw new org.apache.axis2.databinding.ADBException("documentContent cannot be null!!");
                                            }
                                           localDocumentContent.serialize(new javax.xml.namespace.QName("http://www.exchangenetwork.net/schema/node/2","documentContent"),
                                               factory,xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            new javax.xml.namespace.QName("","documentId"));
                                      ...
                                      attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDocumentId));
    ...
    public static class Factory{
        ...
        */
        public static NodeDocumentType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NodeDocumentType object =
                new NodeDocumentType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"NodeDocumentType".equals(type)){
                                ...
                                return (NodeDocumentType)net.exchangenetwork.www.schema.node._2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                   ...
                   if (tempAttribDocumentId!=null){
                         java.lang.String content = tempAttribDocumentId;
                                                 ...
                                                 object.setDocumentId(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToID(tempAttribDocumentId));
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.exchangenetwork.net/schema/node/2","documentName").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.exchangenetwork.net/schema/node/2","documentFormat").equals(reader.getName())){
                                
                                                object.setDocumentFormat(net.exchangenetwork.www.schema.node._2.DocumentFormatType.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.exchangenetwork.net/schema/node/2","documentContent").equals(reader.getName())){
                                
                                                object.setDocumentContent(net.exchangenetwork.www.schema.node._2.AttachmentType.Factory.parse(reader));
