<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ForgotPassword.aspx.cs" Inherits="ForgotPassword_aspx" %>
            ...
            <td>
                ...
                <eaf:FormSectionBlock ID="sec1" Caption="Account Information" runat="server" SectionType="frame">
                    <table class="cc_EntryForm" cellspacing="0">
                        <tr>
                            <td class="fld">
                                <asp:Label ID="Label1" runat="server" AssociatedControlID="">User Name</asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtName" runat="server" MaxLength="40" Width="200px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="fld">
                                <asp:Label ID="Label2" runat="server" AssociatedControlID="txtOldPWD">Old Password</asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtOldPWD" runat="server" MaxLength="40" TextMode="password" Width="200px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="fld">
                                <asp:Label ID="Label3" runat="server" AssociatedControlID="txtNewPWD">New Password</asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtNewPWD" runat="server" MaxLength="40" TextMode="password" Width="200px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="fld">
                               <asp:Label ID="Label4" runat="server" AssociatedControlID="txtNewPWD2">New Password (confirm)</asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtNewPWD2" runat="server" MaxLength="40" TextMode="password" Width="200px"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
