...
NavigatePnl.prototype.writeDivHeader = function()
{
	...
	if(this.DOC_IE || this.DOC_DOM)
	{
		...
		document.write('<table id="TAB_'+this.InstanceName+'" width="'+this.ContainerWidth+'" border="0" cellpadding="0" cellspacing="0" align="'+this.TableAlign+'" style="FILTER:progid:DXImageTransform.Microsoft.Shadow(direction=180,color=#000033,strength=5)">');
