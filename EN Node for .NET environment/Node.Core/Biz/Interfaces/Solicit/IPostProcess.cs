...
{
    /// <summary>
    /// The Interface for Solicit PostProcess
    /// </summary>
    public interface IPostProcess
    {
        /// <summary>
        /// PostProcess of Solicit.
        /// </summary>
        ...
        void Execute(string token, string returnURL, string request, string[] parameters, PostParam param);
    }
}
