...
{
    /// <summary>
    /// The Interface for Execute PostProcess
    /// </summary>
    public interface IPostProcess
    {
        /// <summary>
        /// PostProcess of Excute.
        /// </summary>
        ...
        void Execute(string token, string interfaceName, string methodName, string[] parameters, PostParam param);
    }
}
