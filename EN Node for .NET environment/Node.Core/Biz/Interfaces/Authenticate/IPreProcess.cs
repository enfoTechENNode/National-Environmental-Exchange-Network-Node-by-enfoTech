...
{
    /// <summary>
    /// The Interface for Authenticate PreProcess
    /// </summary>
    public interface IPreProcess
    {
        /// <summary>
        /// PreProcess of Authenticate.
        /// </summary>
        ...
        void Execute(string userID, string credential, string authenticationMethod, PreParam param);
    }
}
