...
using Node.Lib.Utility.Zip.Checksums;
using Node.Lib.Utility.Zip.Compression.Streams;
using Node.Lib.Utility.Zip.Compression;
using Node.Lib.Utility.Zip.Encryption;

namespace Node.Lib.Utility.Zip
{
	...
	public class ZipFile : IEnumerable
	{
		...
		/// An i/o error occurs.
		/// </exception>
        /// <exception cref="Node.Lib.Utility.Zip.ZipException">
