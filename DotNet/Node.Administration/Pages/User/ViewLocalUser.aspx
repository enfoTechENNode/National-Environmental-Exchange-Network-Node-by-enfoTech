<%@ Page Language="C#" MasterPageFile="~/MasterPages/Admin.master" AutoEventWireup="true"
    CodeFile="ViewLocalUser.aspx.cs" Inherits="ViewLocalUser_aspx" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContent" runat="Server">
    ...
    <eaf:FormSectionBlock ID="sec1" Caption="Local Node User Information" runat="server"
        Visible="true">
    ...
    <eaf:FormSectionBlock ID="sec2" Caption="Local Node User Operation Priviledges" runat="server"
        Visible="true">
    ...
    <eaf:ButtonTable ID="btnLUPanel" runat="server" TableWidth="600px">
        <eaf:LeftButtons ID="leftBtnLUPanel" runat="server">
        ...
        <eaf:RightButtons ID="rightBtnLUPanel" runat="server">
