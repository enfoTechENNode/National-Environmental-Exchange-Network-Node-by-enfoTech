<%@ Page Language="C#" MasterPageFile="~/MasterPages/Admin.master" AutoEventWireup="true" CodeFile="NewTaskOperationForWizard.aspx.cs" Inherits="Pages_Operation_NewTaskOperationForWizard" Title="Data Flow Wizard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContent" runat="Server">
        ...
        <eaf:AjaxContentHolder ID="AjaxContentHolder1" runat="server">
            <eaf:AjaxContentTemplate ID="AjaxContentTemplate2" runat="server">
                <table class="cc_EntryForm" cellspacing="0">
                    <tr valign="top">
                        <td class="fld">
                            <asp:Label ID="Label2" runat="server" AssociatedControlID="">Parameter Name:</asp:Label>
                        </td>
                        <td>
                    ...
                    <tr valign="top">
                        <td class="fld">
                            <asp:Label ID="Label3" runat="server" AssociatedControlID="">Parameter Value:</asp:Label>
                        </td>
                        <td>
    ...
    <eaf:FormSectionBlock ID="FormSectionBlock3" Caption="Task Schedule" runat="server"
        ...
        <table class="cc_EntryForm" cellspacing="0">
            <tr valign="top">
                <td class="fld">
                    <asp:Label ID="Label4" runat="server" AssociatedControlID="">Task Schedule Type:</asp:Label>
                </td>
                <td>
            ...
            <tr valign="top">
                <td class="fld">
                    <asp:Label ID="Label5" runat="server" AssociatedControlID="">Start Date:</asp:Label>
                </td>
                <td>
                ...
                <td class="fld">
                    <asp:Label ID="Label6" runat="server" AssociatedControlID="">Start Time:</asp:Label>
                </td>
                <td>
            ...
            <tr valign="top">
                <td class="fld">
                    <asp:Label ID="Label7" runat="server" AssociatedControlID="">End Date:</asp:Label>
                </td>
                <td>
                ...
                <td class="fld">
                    <asp:Label ID="Label8" runat="server" AssociatedControlID="">End Time:</asp:Label>
                </td>
                <td>
            ...
            <asp:View ID="vDaily" runat="server">
                <eaf:FormSectionBlock ID="FormSectionBlock1" Caption="Daily Schedule" runat="server"
                    ...
                    <table class="cc_EntryForm" cellspacing="0">
                        <tr valign="top">
                            <td class="fld">
                                <asp:Label ID="Label9" runat="server" AssociatedControlID="">Interval:</asp:Label>
                            </td>
                            <td>
...
<%--    <eaf:FormSectionBlock ID="FormSectionBlock9" Caption="Email Receivers" runat="server"
    ...
    <eaf:ButtonTable ID="btnPanel" runat="server" TableWidth="600px">
        <eaf:LeftButtons ID="leftBtnPanel" runat="server">
            <eaf:EAFButton ID="btnCancel" runat="server" CssClass="s_BtnGrey" Text="Cancel"
        ...
        <eaf:RightButtons ID="rightBtnPanel" runat="server">
            <eaf:EAFButton ID="btnSave" runat="server" CssClass="s_BtnGreen" Text="Go to Data Flow Wizard" OnClick="btnSave_Click">
            </eaf:EAFButton>
        </eaf:RightButtons>
    </eaf:ButtonTable>
</asp:Content>
