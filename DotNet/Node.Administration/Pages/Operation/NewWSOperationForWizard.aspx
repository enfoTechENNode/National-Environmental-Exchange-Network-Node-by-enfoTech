<%@ Page Language="C#" MasterPageFile="~/MasterPages/Admin.master" AutoEventWireup="true"
    CodeFile="NewWSOperationForWizard.aspx.cs" Inherits="Pages_Operation_NewWSOperationForWizard"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContent" runat="Server">
    ...
    <eaf:FloatWinPanel ID="addExecuteParameter" runat="server" WinTitle="Add Execute Parameter"
        WinWidth="420" WinHeight="90">
        <eaf:AjaxContentHolder ID="AjaxContentHolder1" runat="server">
            <eaf:AjaxContentTemplate ID="AjaxContentTemplate1" runat="server">
                <table class="cc_EntryForm" cellspacing="0">
                    <tr valign="top">
                        <td class="fld">
                            <asp:Label ID="Label4" runat="server" AssociatedControlID="txtExecuteParam">Parameter Name:</asp:Label>
                        </td>
                        <td>
    ...
    <eaf:FormSectionBlock ID="FormSectionBlock2" Caption="Process" runat="server" Visible="true">
        <table class="cc_EntryForm" cellspacing="0">
            <tr valign="top">
                <td class="fld">
                    <asp:Label ID="Label5" runat="server" AssociatedControlID="ddlWebService">Web Service:</asp:Label>
                </td>
                <td>
        ...
        <asp:MultiView ID="mvProcess" runat="server">
            <asp:View ID="vGeneric" runat="server">
                <table class="cc_EntryForm" cellspacing="0">
                    <tr valign="top">
                        <td class="fld">
                            <asp:Label ID="Label2" runat="server" AssociatedControlID="cbDefault">Default Process:</asp:Label>
                        </td>
                        <td>
                            <asp:CheckBox ID="cbDefault" runat="server" ToolTip="Default Process" />
                        </td>
                    </tr>
                </table>
            </asp:View>
            ...
            <asp:View ID="vSolicit" runat="server">
                <%--                <table class="cc_EntryForm" cellspacing="0">
                    ...
                    <tr valign="top">
                        <td class="lftfld">
                            <asp:Label ID="Label6" runat="server" AssociatedControlID="txtSubmitUserID">Submitter User ID:</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtSubmitUserID" runat="server" />
                        </td>
                        <td class="lftfld">
                            <asp:Label ID="Label7" runat="server" AssociatedControlID="txtSubmitPassword">Password:</asp:Label>
                        </td>
                        <td>
                    ...
                    <tr valign="top">
                        <td class="lftfld">
                            <asp:Label ID="Label8" runat="server" AssociatedControlID="txtDataFlow">Data Flow Name</asp:Label>
                        </td>
                        <td colspan="3">
            ...
            <asp:View ID="vExecute" runat="server">
                <eaf:EAFGridView ID="egvExecuteParameters" runat="server" Width="500px" OnRowCommand="egvExecuteParameters_RowCommand">
                    <Columns>
                ...
                <table class="cc_EntryForm" cellspacing="0">
                    <tr valign="top">
                        <td>
                            <input type="button" value="Add Execute Parameters" onclick="<%=addExecuteParameter.ClientID%>Obj.showPanel(this);" />
                        </td>
                        <td>
                            <eaf:EAFButton ID="btnRemoveExecuteParameters" runat="server" Text="Remove Selected Query Parameters"
    ...
    <eaf:ButtonTable ID="btnPanel" runat="server" TableWidth="600px">
        ...
        <eaf:RightButtons ID="rightBtnPanel" runat="server">
            <eaf:EAFButton ID="btnSave" runat="server" CssClass="s_BtnGreen" Text="Go to Data Flow Wizard"
                OnClick="btnSave_Click"></eaf:EAFButton>
        </eaf:RightButtons>
    </eaf:ButtonTable>
</asp:Content>
