...
{
    /// <summary>
    /// The Interface for Notify PreProcess
    /// </summary>
    public interface IPreProcess
    {
        /// <summary>
        /// PreProcess of Notifiy.
        /// </summary>
        ...
        void Execute(string securityToken, string nodeAddress, string dataFlow, NodeDocument[] documents, PreParam param);
    }
}
