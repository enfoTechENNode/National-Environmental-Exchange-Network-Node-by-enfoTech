...
namespace Node.Core.NAASUserManager {
    using System;
    ...
    public partial class usermgr : Microsoft.Web.Services2.WebServicesClientProtocol {
        ...
        /// <remarks/>
        public usermgr() {
            this.Url = global::Node.Core.Properties.Settings.Default.Node_Core_NAASUserManager_usermgr;
        ...
        public string AddUser(string adminName, string adminPwd, string userEmail, UserType userType, string userPwd, string confirmUserPwd, StateId affiliate) {
        ...
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("", RequestNamespace="http://neien.org/schema/usermgr.xsd", ResponseNamespace="http://neien.org/schema/usermgr.xsd")]
        [return: System.Xml.Serialization.SoapElementAttribute("return")]
        public UserInfo[] GetUserList(string adminName, string adminPwd, string userEmail, StateId userState, [System.Xml.Serialization.SoapElementAttribute(DataType="integer")] string rowId, [System.Xml.Serialization.SoapElementAttribute(DataType="integer")] string maxRows) {
