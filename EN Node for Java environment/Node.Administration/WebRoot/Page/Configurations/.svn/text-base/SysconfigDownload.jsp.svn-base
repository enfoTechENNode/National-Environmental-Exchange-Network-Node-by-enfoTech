            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td><br/>
                  <table width="100%">
                  	<tr>
                    	  <td class="formFldLabel">Please click 'Download XML File' to download the system configuration file and save it to your hard drive.</td>
                  	</tr>
                  </table>
                </td>
              </tr>
