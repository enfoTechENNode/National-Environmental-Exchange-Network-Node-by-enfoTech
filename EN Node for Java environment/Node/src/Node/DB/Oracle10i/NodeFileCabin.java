  ...
  public ClsNodeDocument[] GetDocuments(String transID, String dataFlow, String[] operationArr,
	  ...
	  try {
		  ...
		  if(searchDocs!=null && searchDocs.length>0){
			  ...
			  if(operation!=null && !operation.equalsIgnoreCase("") && dataFlow != null && !dataFlow.equalsIgnoreCase("") && !dataFlow.equalsIgnoreCase("NODE")){
				  sql += " and (DATAFLOW_NAME in ("+operation+")) and (";
				  // WI 21157
			  }else if(operation!=null && !operation.equalsIgnoreCase("") && dataFlow != null && !dataFlow.equalsIgnoreCase("") && dataFlow.equalsIgnoreCase("NODE")){
