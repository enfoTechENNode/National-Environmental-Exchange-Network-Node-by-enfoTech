 ...
 */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                           ...
                           */
                           public  net.exchangenetwork.www.schema.node._2.NotificationMessageCategoryType getMessageCategory(){
                            ...
                            /**
                               ...
                               */
                               public void setMessageCategory(net.exchangenetwork.www.schema.node._2.NotificationMessageCategoryType param){
                           ...
                           */
                           public  net.exchangenetwork.www.schema.node._2.TransactionStatusCode getStatus(){
                            ...
                            /**
                               ...
                               * @param param Status
                               */
                               public void setStatus(net.exchangenetwork.www.schema.node._2.TransactionStatusCode param){
                        ...
                        */
                                    ...
                                    protected org.apache.axis2.databinding.types.Id localObjectId ;
                           ...
                           */
                           public  org.apache.axis2.databinding.types.Id getObjectId(){
                            ...
                            /**
                               ...
                               */
                               public void setObjectId(org.apache.axis2.databinding.types.Id param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       NotificationMessageType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":NotificationMessageType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                            ...
                                            if (localObjectId != null){
                                                ...
                                                writeAttribute("",
                                                         "objectId",
                                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localObjectId), xmlWriter);

                                            
                                      }
                                    
                                      else {
                                          throw new org.apache.axis2.databinding.ADBException("required attribute localObjectId is null");
                                      }
                                    
                                            if (localMessageCategory==null){
                                                 throw new org.apache.axis2.databinding.ADBException("messageCategory cannot be null!!");
                                            }
                                           localMessageCategory.serialize(new javax.xml.namespace.QName("http://www.exchangenetwork.net/schema/node/2","messageCategory"),
                                               factory,xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                                           ...
                                           localStatus.serialize(new javax.xml.namespace.QName("http://www.exchangenetwork.net/schema/node/2","status"),
                                               factory,xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://www.exchangenetwork.net/schema/node/2",
                                    ...
                                    elementList.add(localStatus);
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://www.exchangenetwork.net/schema/node/2",
                                        ...
                                        if (localStatusDetail != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localStatusDetail));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("statusDetail cannot be null!!");
                                        }
                            ...
                            new javax.xml.namespace.QName("","objectId"));
                                      ...
                                      attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localObjectId));
    ...
    public static class Factory{
        ...
        */
        public static NotificationMessageType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NotificationMessageType object =
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"NotificationMessageType".equals(type)){
                                ...
                                return (NotificationMessageType)net.exchangenetwork.www.schema.node._2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    java.lang.String tempAttribObjectId =
                        
                                reader.getAttributeValue(null,"objectId");
                            
                   if (tempAttribObjectId!=null){
                         java.lang.String content = tempAttribObjectId;
                        
                                                 object.setObjectId(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToID(tempAttribObjectId));
                                            
                    } else {
                       
                               throw new org.apache.axis2.databinding.ADBException("Required attribute objectId is missing");
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.exchangenetwork.net/schema/node/2","messageCategory").equals(reader.getName())){
                                
                                                object.setMessageCategory(net.exchangenetwork.www.schema.node._2.NotificationMessageCategoryType.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.exchangenetwork.net/schema/node/2","messageName").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.exchangenetwork.net/schema/node/2","status").equals(reader.getName())){
                                
                                                object.setStatus(net.exchangenetwork.www.schema.node._2.TransactionStatusCode.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.exchangenetwork.net/schema/node/2","statusDetail").equals(reader.getName())){
