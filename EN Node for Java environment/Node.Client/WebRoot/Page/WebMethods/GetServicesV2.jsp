...
<html>
	<head>
		...
		<title>Exchange Network Node</title>
      	...
      	<body >
          <form action="/Node.Client/Page/WebMethods/GetServices.do?version=VER_20" method="POST" name="form1">
                            ...
                            <td>
                              <table width="100%">
                                <tr>
                                  ...
                                  <td>
                                    <select name="nodeAddress3">
                                      <%
                                      	String[] clientURLs = GetServicesBean.getClientURLs_V2();
                                      	boolean	isSelected = false;
                                       if (clientURLs != null) {
                                         for (int i = 0; i < clientURLs.length; i++) {
                                           if (clientURLs[i].equals(GetServicesBean.getNodeAddress3()))
                                             isSelected = true;
                                         }
                                       }
                                       if (isSelected) {
                                ...
                                <tr>
                                  ...
                                  <td><eftwc:HighlightTextBox id="nodeAddress4" size="80" text="<%=GetServicesBean.getNodeAddress4()%>" /></td>
                                </tr>
                              </table>
                            </td>
                          </tr>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <select name="serviceType">
										<%
											String[] serviceType = { "AllServices", "Solicit", "Query",
													"Execute" };
                        ...
                        <table width="30%">
                          <tr>
                            ...
                            <td>
                              <table width="100%">
                                <tr>
                            		<td><eftwc:HighlightTextBox id="result" rows="7" size="120" text="<%=GetServicesBean.getServiceXML()%>" /></td>
                                </tr>
                              </table>
                            </td>
                          </tr>
