...
<jsp:useBean id="GetStatusBean" class="Node.Web.Client.Bean.WebMethods.GetStatusBean" scope="request" />
	...
	<head>
		...
		<title>Exchange Network Node</title>
               ...
               <script language="JavaScript">
                ...
                <%
                String error = GetStatusBean.getError();
      	...
      	<body >
          <form action="/Node.Client/Page/WebMethods/GetStatus.do?version=VER_20" method="POST" name="form1">
            ...
            <table class="formFldLabel" width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td>
                  <table width="100%">
                    <tr>
                      <td class="formTitle" nowrap="nowrap" width="100%" height="20" background="/Node.Client/eftWC/skin/img/pnl/tskpnl_bar_bg.gif">&nbsp;GetStatus</td>
                    </tr>
                  </table>
                </td>
              </tr>
                  ...
                  <table width="100%" frame="box">
                            ...
                            <td>
                              <table width="100%">
                                <tr>
                                  ...
                                  <td>
                                    <select name="nodeAddress3">
                                      <%
                                      	String[] clientURLs = GetStatusBean.getClientURLs_V2();
                                      	boolean	isSelected = false;
                                       if (clientURLs != null) {
                                         for (int i = 0; i < clientURLs.length; i++) {
                                           if (clientURLs[i].equals(GetStatusBean.getNodeAddress3()))
                                             isSelected = true;
                                         }
                                       }
                                       if (isSelected) {
                                ...
                                <tr>
                                  ...
                                  <td><eftwc:HighlightTextBox id="nodeAddress4" size="80" text="<%=GetStatusBean.getNodeAddress4()%>" /></td>
                                </tr>
                              </table>
                            </td>
                          </tr>
                    ...
                    <tr>
                      <td>
                        <table width="100%">
                          <tr>
                            <td class="formTitle">GetStatus Parameters</td>
                          </tr>
                          <tr>
                            <td>
                              <table width="100%">
                                      <tr>
                                        ...
                                        <td><eftwc:HighlightTextBox id="token" size="80" text="<%=GetStatusBean.getToken()%>" /></td>
                                      </tr>
                                      <tr>
                                        <td class="formFldLabel" nowrap="nowrap">Transaction ID:</td>
                                        <td><eftwc:HighlightTextBox id="transID" size="80" text="<%=GetStatusBean.getTransID()%>" /></td>
                                      </tr>
                              </table>
                            </td>
                          </tr>
                          <tr>
                            <td>
                              <table width="100%">
                                <tr>
                                  <td><eftwc:AquaButton buttonText="GetStatus" onClickScript="submitForm('GET_STATUS')" /></td>
                                </tr>
                              </table>
                            </td>
                          </tr>
                      ...
                      <td>
                        <table width="30%">
                          <tr>
                            ...
                            <td><eftwc:HighlightTextBox id="result" text="<%=GetStatusBean.getResult()%>" size="80" /></td>
                          </tr>
                        </table>
                      </td>
                    </tr>
