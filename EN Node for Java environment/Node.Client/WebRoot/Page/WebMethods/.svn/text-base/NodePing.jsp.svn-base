...
<html>
	<head>
		...
		<title>Exchange Network Node</title>
      	...
      	<body >
          <form action="/Node.Client/Page/WebMethods/NodePing.do?version=VER_11" method="POST" name="form1">
                            ...
                            <td>
                              <table width="100%">
                                <tr>
                                  ...
                                  <td>
                                    <select name="nodeAddress1">
                                      <%
                                      	String[] clientURLs = NodePingBean.getClientURLs();
                                      	boolean	isSelected = false;
                                       if (clientURLs != null) {
                                         for (int i = 0; i < clientURLs.length; i++) {
                                           if (clientURLs[i].equals(NodePingBean.getNodeAddress1()))
                                             isSelected = true;
                                         }
                                       }
                                       if (isSelected) {
                                ...
                                <tr>
                                  ...
                                  <td><eftwc:HighlightTextBox id="nodeAddress2" size="80" text="<%=NodePingBean.getNodeAddress2()%>" /></td>
                                </tr>
                              </table>
                            </td>
                          </tr>
